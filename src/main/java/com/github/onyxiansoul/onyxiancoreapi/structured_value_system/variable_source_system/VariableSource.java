...
public interface VariableSource{
  ...
  */
  ...
  public <T> T getField(String fieldName) throws VariableCreationException;
  
  public <T> T getField(int fieldNumber) throws VariableCreationException;
  
  public <T> T getOnlyField() throws VariableCreationException;
  
  public <T> T getOnlyFieldOrFieldOfName(String fieldName) throws VariableCreationException;
  ...
  public <T> T getOnlyFieldOrFieldOfNameOrThisAs(String fieldName, String variableType) throws VariableCreationException;
   ...
   * Basicly, its a way to allow pre-processing of a field to create a variable, that can be used to create the intended variable. For example: processing a biome name string, and using that string to create the biome variable*/
  public <T> T getOnlyFieldOrFieldOfNameOrThis(String fieldName) throws VariableCreationException;
  
  public <T> T getFieldOrRegisteredVariable(String fieldName, String registeredVariableName) throws VariableCreationException;
  ...
  public <T> T getFieldOrRegisteredVariableWrappedValue(String fieldName, String registeredVariableName) throws VariableCreationException, ImpossibleActionException;
  ...
  public <T> T getFieldWrappedValue(String fieldName) throws VariableCreationException, ImpossibleActionException;
  ...
  public <T> T getFieldWrappedValueOrDefault(String fieldName, T defaultValue) throws VariableCreationException, ImpossibleActionException;
  ...
  public <T> T getFieldOrDefault(String field, T defaultValue) throws VariableCreationException, ImpossibleActionException;
